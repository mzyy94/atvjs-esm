'use strict';require('tvml');var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};var lodash = {exports: {}};/**
 * @license
...
function ajax(url, options, method = "GET") {
    ...
    return new Promise((resolve, reject) => {
        ...
        xhr.open(
        // FIXME
        options.method, url, typeof options.async === "undefined" ? true : options.async, options.user, options.password);
        // set headers
...
Object.assign(ajax, methods);// base menu string for initial document creation
...
_.assign(Settings, lib);// external libraries
